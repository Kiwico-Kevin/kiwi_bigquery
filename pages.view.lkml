  ...
  dimension: path_type {
    sql:
      CASE
        ...
        OR ${path} LIKE '/subscription/manage/index/id/%'
        OR ${path} LIKE '/customer/store-orders%'
        OR ${path} LIKE '/kiwicrate_customeraccount/credits%'
        OR ${path} LIKE '/customer/reset-password%'
        OR ${path} LIKE '/customer/login%'
        OR ${path} LIKE '/customer/account%'
