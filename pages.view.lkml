  ...
  dimension: path_type {
    sql:
      CASE
        ...
        WHEN ${path} LIKE '/kiwicrate_customeraccount/subscriptions'
        or ${path} LIKE '/subscription/manage/index/id/%'
        or ${path} LIKE '/kiwicrate_customeraccount/orders%'
        or ${path} LIKE '/customer/account/forgotpassword%'
        or ${path} LIKE '/customer/account/login%'
