  ...
  dimension: path_type {
    sql:
      CASE
        ...
        WHEN ${path} LIKE '/customer/subscriptions%'
        OR WHEN ${path} LIKE '/subscription/manage/index/id/%'
        OR WHEN ${path} LIKE '/customer/store-orders%'
        OR WHEN ${path} LIKE '/kiwicrate_customeraccount/credits%'
        OR WHEN ${path} LIKE '/customer/reset-password%'
        OR WHEN ${path} LIKE '/customer/login%'
        OR WHEN ${path} LIKE '/customer/account%'
        ...
        WHEN ${path} LIKE '/yummy%' THEN 'Yummy Page'
        ...
        WHEN ${path} LIKE '/store%' or ${path} LIKE '/us/store%' THEN 'Store'
        ...
        WHEN ${path} LIKE '/kt/checkout%' THEN 'Checkout'
        WHEN ${path} LIKE '/kt/cart%' THEN 'View Cart'
        WHEN ${path} LIKE '/get-started%' THEN 'Purchase Widget'
        ELSE 'Other'
    END;;
  }
