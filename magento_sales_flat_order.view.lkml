view: magento_sales_flat_order {
  sql_table_name: rdstobigquery.magento_sales_flat_order ;;
  ...
  dimension: base_giftcert_amount {
    type: number
    sql: ${TABLE}.base_giftcert_amount ;;
  }
  ...
  dimension: base_kcredits_amount {
    type: number
    sql: ${TABLE}.base_kcredits_amount ;;
  }

  dimension: base_payment_fee_amount {
    type: number
    sql: ${TABLE}.base_payment_fee_amount ;;
  }

  dimension: base_payment_fee_tax {
    type: number
    sql: ${TABLE}.base_payment_fee_tax ;;
  }

  dimension: base_payment_installment_fee_amount {
    type: number
    sql: ${TABLE}.base_payment_installment_fee_amount ;;
  }

  dimension: base_payment_percentage_fee {
    type: number
    sql: ${TABLE}.base_payment_percentage_fee ;;
  }
  ...
  dimension: bt_export_status {
    type: string
    sql: ${TABLE}.bt_export_status ;;
  }
  ...
  dimension: kcredits_amount {
    type: number
    sql: ${TABLE}.kcredits_amount ;;
  }
  ...
  dimension: payment_fee_amount {
    type: number
    sql: ${TABLE}.payment_fee_amount ;;
  }

  dimension: payment_fee_tax {
    type: number
    sql: ${TABLE}.payment_fee_tax ;;
  }

  dimension: payment_installment_fee_amount {
    type: number
    sql: ${TABLE}.payment_installment_fee_amount ;;
  }

  dimension: payment_percentage_fee {
    type: number
    sql: ${TABLE}.payment_percentage_fee ;;
  }
  ...
  dimension_group: tj_salestax_sync {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.tj_salestax_sync_date ;;
  }
