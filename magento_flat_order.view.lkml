view: magento_flat_order {
  sql_table_name: javascript.magento_flat_order ;;
  ...
  dimension: base_shipping_hidden_tax_amount {
    type: number
    sql: ${TABLE}.base_shipping_hidden_tax_amount ;;
  }
  ...
  dimension: forced_do_shipment_with_invoice {
    type: string
    sql: ${TABLE}.forced_do_shipment_with_invoice ;;
  }
  ...
  dimension: payment_authorization_expiration {
    type: string
    sql: ${TABLE}.payment_authorization_expiration ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [customer_firstname, customer_lastname, store_name, customer_middlename]
  }
}
